...
from hdx.scraper.hrp_plans._version import __version__
from hdx.scraper.hrp_plans.pipeline import Pipeline

logger = logging.getLogger(__name__)

_LOOKUP = "hdx-scraper-hrp-plans"
_SAVED_DATA_DIR = "saved_data"  # Keep in repo to avoid deletion in /tmp
_UPDATED_BY_SCRIPT = "HDX Scraper: HRP Plans"
...
def main(
    ...
    User.check_current_user_write_access("ocha-fts")
